...
class Homepage extends Component {
  ...
  <h1 class="animate__animated animate__fadeIn animate__delay-1s" align="right" style={{ color: "white", fontFamily: "serif" }}>Welcome to Secure Airways</h1>
</div>
                    ...
                    <div class="container-fluid">
                        ...
                        <Carousel fade>
                            ...
                            <Carousel.Item>
                                <img
                                    className="d-block w-100"
                                    src="https://www.cheapflights.com/news/wp-content/uploads/sites/136/2019/04/booking-the-best-airplane-seat-02.jpg"
                                    alt="Second slide"
                                    style={{ 'height': "90vh" }}
                                />
                        ...
                        <div>
                            <form onSubmit={this.showFlights} >
                                ...
                                <div className="form-group offset-md-4 col-md-4" align="center">
                                    ...
                                    <input style={rounded} type="date" placeholder="Travel Date" name="travel_Date" className="form-control " required
