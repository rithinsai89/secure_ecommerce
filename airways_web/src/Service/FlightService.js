...
const FLIGHT_API_BASE_URL = "http://localhost:8080/ARS";
...
class FlightService {
    ...
    createFlight(flight) {
        var URL = "http://localhost:8080/ARS/addFlight";
        console.log("Flight data: " + flight);
        return axios.post(URL, flight);
    }

    DisplayFlightByFLightNo(flight_No) {
        var URL = "http://localhost:8080/ARS/getFlightByNumber/" + flight_No;
    ...
    DisplayTicketDetailsByBookingId(booking_Id) {
        var URL = "http://localhost:8080/ARS/DisplayTicketDetails/" + booking_Id;
        return axios.get(URL);
    }
    ...
    getCities() {
        return axios.get('http://localhost:8080/ARS/cities')
    }

    destination() {
        return axios.get('http://localhost:8080/ARS/destination')
    }
